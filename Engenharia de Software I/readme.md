...
VLM (VIsual Language Model): Modelo com arquitetura **multimodal** que aprende e associa por meio de imagens e textos.
<br>
Um tipo de IA generativa que recebe como entrada(input) imagens e textos e, como saída gera texto. <br>
Consegue analisar diversos tipos de imagens, incluindo documentos, páginas web, etc, além de responder questões sobre as imagens fornecidas, seja posição de algum objeto, interpretação da imagem...
...
Acesso ao código Java:
 <a href="Engenharia de Software I/DiagramaUML/BibliotecaBertoti/src/Biblioteca"> Clique Aqui! </a>
